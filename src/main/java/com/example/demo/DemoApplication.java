...
public class DemoApplication {
    ...
    public CommandLineRunner demo(
        ...
        return (args) -> {
            ...
            // 3. Dodawanie Questów (z klimatem wikingów)
            if (questRepository.count() == 0) {
                questRepository.save(new Quest(null, "Szczury w Medhall", "Karczmarz w Medhall narzeka na hałas z piwnicy.", 1, 50, 20));
                questRepository.save(new Quest(null, "Zaginiony Amulet Thora", "Jarl zgubił rodzinny amulet w lesie.", 5, 80, 40));
                questRepository.save(new Quest(null, "Trolle na szlaku", "Kupcy boją się podróżować przez góry.", 10, 150, 80));
                questRepository.save(new Quest(null, "Draugr w kurhanie", "Nieumarli wojownicy straszą wioskę.", 15, 250, 120));
                questRepository.save(new Quest(null, "Łup z Lindisfarne", "Wyprawa łupieżcza na odległe wybrzeża.", 20, 400, 200));
