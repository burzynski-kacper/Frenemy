    ...
    public CommandLineRunner demo(
        ...
        return (args) -> {
            ...
            if (enemyRepository.count() == 0) {
                ...
                CharacterClass berserker = characterClassRepository.findByName("Berserker").orElse(null);
                CharacterClass tropiciel = characterClassRepository.findByName("Tropiciel").orElse(null);
                CharacterClass walkiria = characterClassRepository.findByName("Walkiria").orElse(null);
                CharacterClass mistrzRun = characterClassRepository.findByName("Mistrz Run").orElse(null);
                ...
                if (questRepository.count() == 0) {
                    questRepository.save(new Quest(null, "Szczury w Medhall", "Karczmarz w Medhall narzeka na hałas z piwnicy.", 1, 50, 20, 1L, 1, null));
                    questRepository.save(new Quest(null, "Zaginiony Amulet Thora", "Jarl zgubił rodzinny amulet w lesie.", 5, 80, 40, 2L, 1, null));
                    questRepository.save(new Quest(null, "Trolle na szlaku", "Kupcy boją się podróżować przez góry.", 10, 150, 80, 3L, 4, null));
                    questRepository.save(new Quest(null, "Draugr w kurhanie", "Nieumarli wojownicy straszą wioskę.", 15, 250, 120, 4L, 7, null));
                    questRepository.save(new Quest(null, "Łup z Lindisfarne", "Wyprawa łupieżcza na odległe wybrzeża.", 20, 400, 200, 5L, 10, null));
